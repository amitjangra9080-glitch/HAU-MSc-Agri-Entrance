...
- Firebase project: `hau-msc-agri-entrance-2026`
- Suggested Vercel project: `hau-msc-agri-entrance`

## Flow

1. Build and test locally.
2. Create Firebase project `hau-msc-agri-entrance-2026`.
3. Paste the new Firebase web config into `src/firebase-config.js`.
